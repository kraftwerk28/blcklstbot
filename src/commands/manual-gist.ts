...
import { noop, runEnry, uploadToGist } from "../utils/index.js";
import { link, userMention } from "../utils/html.js";

// const composer = new Composer();

// composer.chatType(["group", "supergroup"]).command("gist").use(botHasSufficientPermissions);
